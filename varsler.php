...
<div class="container-md list-group shadow">
    <div class="row">
        <div class="list-group-item col-md-3" style="background: linear-gradient(#A0FFA1, #FFB899);">
        ...
        <span><h3>Fredag</h3><img src="images/kategori2.png" style="height: 60px; width: 60px"><img src="images/varsel_vind.png" style="height: 60px; width: 60px"><h4>Kategori 2</h4><p>Stærk storm 12:45 -</p></span>
        </div>

        <div class="list-group-item col-md" style="background: linear-gradient(#F1FF93, #FFB899);">
        <span><h3>Lørdag</h3><img src="images/kategori2.png" style="height: 60px; width: 60px"><img src="images/varsel_vind.png" style="height: 60px; width: 60px"><h4>Kategori 2</h4><p>Stærk storm Hele dagen</p></span>
        </div>

        <div class="list-group-item col-md" style="background: linear-gradient(#B4D2FF, #FFB899);">
        <span><h3>Søndag</h3><img src="images/kategori1.png" style="height: 60px; width: 60px"><img src="images/varsel_vind.png" style="height: 60px; width: 60px"><h4>Kategori 1</h4><p>Storm - 20:00</p></span>
        </div>
    </div>
</div>
<br>
